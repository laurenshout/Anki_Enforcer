...
from aqt.qt import QDialog, QHBoxLayout, QLabel, QPixmap, QTimer, Qt, QVBoxLayout
...
class PopupManager:
    ...
    def show_warning(self, parent: Any, config: dict[str, Any], reason: str = "") -> None:
    ...
    def _pick_image(self) -> Optional[Path]:
        folder = IMAGES_DIR
        ...
        logger.warning(
            "No loadable popup images found in %s (files present but invalid/unreadable).",
            folder,
        )
        return None
